...
class _CreatureDetailScreenState extends State<CreatureDetailScreen> {
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text("${_creature.name}", style: TextStyle(fontSize: baseSize * (2/3), color: Colors.black),),
                      ),
                      Padding(
                        padding: EdgeInsets.only(top: baseSize / 2, right: baseSize / 2),
                        child: Column(
                          children: [
                            Text("종류: ${_creature.type}", style: TextStyle(fontSize: baseSize / 4, color: Colors.black),),
                          ],
                        ),
                      )
                    ],
  ...
  _showSelectSource(BuildContext context) {
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text('사진을 촬영하거나 가져오기', textAlign: TextAlign.center,),
            content: Row(
              mainAxisAlignment: MainAxisAlignment.center,
